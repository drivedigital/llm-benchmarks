          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {run.simulated && (
                  <span
                    title="Sample data from the offline simulator — wiped by Purge data"
                    className="shrink-0 rounded-full bg-amber-500/10 px-1.5 py-0.5 text-[10px] font-semibold tracking-wide text-amber-300"
                  >
                    SIM
                  </span>
                )}
              ...
              {run.status === "running" ? (
                ...
                <p className="mt-0.5 truncate text-[12px] text-slate-500">
                  {formatTokS(run.tokensPerSec)} Â· {formatMs(run.durationMs)} Â·{" "}
