      ...
      <div className="relative mx-auto max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Real-time profiling across {models.length} local engine models \u00b7 Jan.ai
                REST API
              </p>
            </div>
          </div>
        ...
        <div className="mb-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-lg shadow-black/20 backdrop-blur">
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="text-[11px] text-slate-500">click a column to sort \u00b7 click a row for details</span>
          </div>
          <LeaderboardTable
            models={models}
            runs={runs}
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-lg shadow-black/20 backdrop-blur">
              ...
              <p className="mb-3 text-[11px] text-slate-500">
                Trigger an immediate one-off run outside the rotation \u2014 useful for spot
        ...
        <footer className="mt-8 pb-4 text-center text-[11px] text-slate-600">
          Jan Bench Analytics \u00b7 simulated telemetry until a live Jan server connection is
          confirmed \u00b7 OpenAI-compatible REST API
        </footer>
      </div>
